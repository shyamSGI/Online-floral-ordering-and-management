<?php
    ...
    $user_authentication_query="select id,email,type,name from users where email='$email' and password='$password'";
    ...
    if($rows_fetched==0){
        ...
        $row=mysqli_fetch_array($user_authentication_result);
				...
				{	 	$_SESSION['email']=$email;
						...
						$user=$row['name'];
						$_SESSION['user']=$user;
						header('location: admin_action.php?logged=true&user='.$user);
				...
				{	 	$_SESSION['email']=$email;
						...
						$user=$row['name'];
						$_SESSION['user']=$user;
						header('location: manager_action.php?manager_logged=true&user='.$user);
